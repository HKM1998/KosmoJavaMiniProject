...
public class Ending004_NormalEnding_02 extends Ending{
	...
	public void printScript() {
		...
		script.append("\n당신은 계속 떠돌며 방황하다 우연히 쉘터를 발견하게 되었습니다.\n");
		script.append("고된 여정으로 인해 지친 몸을 이끌고 겁도 없이 쉘터 내부로 들어갔습니다.\n");
		...
		script.append("당신은 이렇게 완벽한 장소에 사람이 아무도 없단걸 알고 자신의 거처로 삼으려던 찰나에\n");
		script.append("꺼림칙한 느낌이 들어 뒤를 돌아본 순간.\n");
		script.append("\n당신은 탁 쏘는 강렬한 약품 냄새가 입과 코로 밀려들어오는 느낌을 받고\n");
