...
public class Ending001_GoodEnding extends Ending {
	...
	public void printScript() {
		...
		script.append("빈차에서 미스테리한 지도를 얻은 당신은 이게 무슨 지도일까 곰곰히 생각합니다.");
		...
		script.append("당신은 주변 풀숲에 급하게 숨습니다. 아뿔싸! 녀석들은 갱단들이었습니다.");
		...
		script.append("그렇게 하여 비록 힘든 여정이긴 하였으나 당신은 무사히 집으로 돌아갈 수 있게 되었습니다.");
