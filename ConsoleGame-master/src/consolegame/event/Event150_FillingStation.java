...
public class Event150_FillingStation extends Event {
	...
	public void printScript() {
		...
		script.append("들고있는 30대 중반의 남성이 보입니다.\n");
		script.append("남성의 근처로 가보니 큰 상자는 200원 작은상자는 100원에 판매한다고 적힌 팻말을 들고 서있습니다.\n");
		script.append("상자안의 내용물이 뭔지는 모르겠다 하지만 궁금합니다.\n");
		script.append("사볼까?\n");
	...
	public void getResult(String pChoice) {
		...
		if (pChoice.equals("1")) { // 1번은 금액 200원을 쓰고 칼 획득
			...
			if (Main.character.getMoney() > 100) {
				script.append("소지금 100을 사용하여 작은상자를 구매하였습니다.\n");
				script.append("(+ 진통제)\n");
