...
public class Event200_Mart extends Event {
	public Event200_Mart() {
		...
		public void printChoice(Character c) {
			...
			selection.addSelection(" 칼을 산다. "); // (자금 -100)
			selection.addSelection(" 통조림을 산다. "); // (자금- 50)
			selection.addSelection(" 총을 산다. "); // (자금- 200)
			selection.addSelection(" 탄약을 산다. "); // (자금- 50)
			selection.addSelection(" 고기를 산다. "); // (자금- 200)
			selection.addSelection(" 보존식량을 산다. "); // (자금- 50)
